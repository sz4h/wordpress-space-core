...
(function ($) {
    ...
    function mediaOffloadSettingsPayload() {
        ...
        var payload = {
            ...
            theme_cdn_enabled: $('#sc-mo-theme-cdn-enabled').is(':checked') ? 1 : 0,
            theme_cdn_active_base: $('#sc-mo-theme-cdn-active').val() || '',
            theme_cdn_parent_base: $('#sc-mo-theme-cdn-parent').val() || '',
            endpoint: '',
            region: '',
            access_key: '',
            secret_key: ''
